...
public class Main extends PApplet {
	...
	public void draw() {
		if (run == 1) {
			...
			// Ciara O'Sullivan and Krishanu Dey
			image(backgroundImage, 0, 0);
			stroke(50);
			fill(15);
			if (currentScreen == 1) {
	...
	public void initialiseResultPage(ControlP5 screen2) {
		...
		exitButtonResultsPage = new Button(screen2, "exitButton2").setImage(loadImage("data\\x-mark.png"));
		...
		backButton.setColorActive(buttonColour).setColorActive(activeColour).setColorForeground(color(255, 10, 10));
	...
	public void initialiseScreen(ControlP5 screen) {
		...
		exitButton = new Button(screen, "exitButton2").setImage(loadImage("data\\x-mark.png"));
		exitButton.setColorBackground(buttonColour).setColorActive(activeColour).setColorForeground(activeColour);
		exitButton.setHeight((int) (screenWidth / 25)).setWidth((int) screenWidth / 25);
		exitButton.setPosition((float) (screenWidth - exitButton.getWidth()), (float) 0);
	...
	public void dateSort() {
		//MAtthew henry -- Runs a SQL query where reviews are returned based on input dates from the respective text boxes
